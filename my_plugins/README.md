...
# map functions
zcompile ~/zplugins $ZSH_CUSTOM/plugins/*/{'_'*,*.plugin.zsh}

#  read files -R?
zcompile ~/zfiles $ZSH_CUSTOM/{.zshrc,.zlogout,.zlogin,.zshenv,completions.zsh}

# what do to with /lib files
...
#   directory (see 2a9a003), and that is a plain file with more than 1K
